x-anthropic-billing-header: <harnessVariable>{{anthropicBillingHeader=cc_version=2.1.234.b34; cc_entrypoint=sdk-cli; cch=00000;}}</harnessVariable> cc_prompt_id=<harnessVariable>{{sessionId=9f19687c-da31-4ca4-aff4-1c12be68ecce}}</harnessVariable>;
...
# Environment
 - You are powered by the model named <harnessVariable>{{modelDisplayName=Fable 5}}</harnessVariable>. The exact model ID is <harnessVariable>{{modelId=claude-fable-5}}</harnessVariable>.
