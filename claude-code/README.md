...
- `interactive/` contains a tmux interactive capture from the CLI REPL. It records the interactive prompt and the reduced eager tool set sent for the main Sonnet request.
