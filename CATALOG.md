...
Observed release: `1.1.11`

| Surface | Category | Models | Modes | Status | Captured | Artifacts |
| --- | --- | --- | --- | --- | --- | --- |
| `antigravity.prompt.agent.gemini-3-6-flash-high.non-interactive` | agent prompt | `gemini-3.6-flash-high` | `non-interactive` | current | `1.1.11` | [gemini-3.6-flash-high.md](antigravity/prompts/gemini-3.6-flash-high.md) |
| `antigravity.prompt.agent.gemini-3-6-flash-high.interactive` | agent prompt | `gemini-3.6-flash-high` | `interactive` | current | `1.1.11` | [gemini-3.6-flash-high-interactive.md](antigravity/prompts/gemini-3.6-flash-high-interactive.md) |
| `antigravity.tool.catalog` | tool schemas | `gemini-3.6-flash-high` | `non-interactive`, `interactive` | current | `1.1.11` | 17 files ([manifest](antigravity/SURFACES.json)) |
| `antigravity.agent.definitions` | bundled agent prompts | `gemini-3.6-flash-high` | `research and self subagents` | gap | — | — |
| `antigravity.skill.definitions` | bundled skills | `gemini-3.6-flash-high` | `skill invocation` | gap | — | — |
| `antigravity.command.definitions` | slash commands | `gemini-3.6-flash-high` | `command invocation` | gap | — | — |
| `antigravity.event.catalog` | event prompts | `gemini-3.6-flash-high` | `task`, `schedule`, `background result`, `subagent result`, `peer message`, `plan` | gap | — | — |
| `antigravity.mcp.instructions` | MCP and rules prompts | `gemini-3.6-flash-high` | `MCP and rules enabled` | gap | — | — |
| `antigravity.context.session` | dynamic context | `gemini-3.6-flash-high` | `all` | dynamic | — | — |
| `antigravity.assembly.model-mode` | assembly recipe | `gemini-3.6-flash-high` | `non-interactive`, `interactive` | gap | — | — |
| `antigravity.prompt.model-variants` | model and reasoning variants | `other response models` | `reasoning variants` | gap | — | — |

## claude-code

Observed release: `2.1.226`
...
| `claude-code.prompt.agent.claude-sonnet-5.interactive` | agent prompt | `claude-sonnet-5` | `interactive` | current | `2.1.226` | [claude-sonnet-5-interactive.md](claude-code/prompts/claude-sonnet-5-interactive.md) |
...
| `claude-code.steering.non-interactive` | steering messages | `claude-fable-5` | `non-interactive` | stale | `2.1.221` | [claude-fable-5-steering.md](claude-code/misc/claude-fable-5-steering.md) |
| `claude-code.steering.interactive` | steering messages | `claude-sonnet-5` | `interactive` | current | `2.1.226` | [claude-sonnet-5-interactive-steering.md](claude-code/misc/claude-sonnet-5-interactive-steering.md) |
| `claude-code.tool.catalog` | tool schemas | `supported model catalog` | `non-interactive`, `interactive` | current | `2.1.226` | 36 files ([manifest](claude-code/SURFACES.json)) |
...
Observed release: `0.2.113`

| Surface | Category | Models | Modes | Status | Captured | Artifacts |
| --- | --- | --- | --- | --- | --- | --- |
| `grok.prompt.agent.grok-4-5.non-interactive` | agent prompt | `grok-4.5` | `non-interactive` | verified-unchanged | `0.2.113` | [grok-4.5.md](grok/prompts/grok-4.5.md) |
| `grok.prompt.agent.grok-4-5.interactive` | agent prompt | `grok-4.5` | `interactive` | verified-unchanged | `0.2.113` | [grok-4.5-interactive.md](grok/prompts/grok-4.5-interactive.md) |
| `grok.prompt.special.session-title` | session title prompt | `grok-4.5` | `session-title` | verified-unchanged | `0.2.113` | [grok-session-title.md](grok/prompts/grok-session-title.md) |
| `grok.steering.catalog` | steering messages | `grok-4.5` | `non-interactive`, `interactive` | verified-unchanged | `0.2.113` | [grok-4.5-steering.md](grok/misc/grok-4.5-steering.md), [grok-4.5-interactive-steering.md](grok/misc/grok-4.5-interactive-steering.md) |
| `grok.tool.catalog` | tool schemas | `grok-4.5` | `non-interactive`, `interactive`, `session-title` | current | `0.2.113` | 28 files ([manifest](grok/SURFACES.json)) |
| `grok.agent.definitions` | bundled agent prompts | `grok-4.5` | `subagent invocation` | gap | — | — |
| `grok.skill.definitions` | bundled skills and workflows | `grok-4.5` | `skill and workflow invocation` | gap | — | — |
| `grok.event.catalog` | event prompts | `grok-4.5` | `plan`, `scheduler`, `workflow`, `monitor`, `completion` | gap | — | — |
