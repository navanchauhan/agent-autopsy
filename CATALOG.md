...
Observed release: `0.157.1`

| Surface | Category | Models | Modes | Status | Captured | Artifacts |
| --- | --- | --- | --- | --- | --- | --- |
| `codex.prompt.agent.catalog` | agent prompts | `gpt-6-astra`, `gpt-5`, `gpt-5.1`, `gpt-5.2`, `gpt-5.4`, `gpt-5.5`, `gpt-5.6` | `default`, `review` | current | `0.157.1` | 16 files ([manifest](codex/SURFACES.json)) |
| `codex.tool.catalog` | tool schemas | `all` | `configured` | current | `0.157.1` | 25 files ([manifest](codex/SURFACES.json)) |
| `codex.steering.catalog` | runtime messages | `all` | `configured`, `multi-agent`, `realtime`, `review` | current | `0.157.1` | 29 files ([manifest](codex/SURFACES.json)) |
