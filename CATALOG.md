...
| `claude-code.prompt.agent.claude-sonnet-5.interactive` | agent prompt | `claude-sonnet-5` | `interactive` | current | `2.1.231` | [claude-sonnet-5-interactive.md](claude-code/prompts/claude-sonnet-5-interactive.md) |
...
| `claude-code.steering.interactive` | steering messages | `claude-sonnet-5` | `interactive` | current | `2.1.231` | [claude-sonnet-5-interactive-steering.md](claude-code/misc/claude-sonnet-5-interactive-steering.md) |
| `claude-code.tool.catalog` | tool schemas | `supported model catalog` | `non-interactive`, `interactive` | current | `2.1.231` | 36 files ([manifest](claude-code/SURFACES.json)) |
...
Observed release: `0.2.117`

| Surface | Category | Models | Modes | Status | Captured | Artifacts |
| --- | --- | --- | --- | --- | --- | --- |
| `grok.prompt.agent.grok-4-6.non-interactive` | agent prompt | `grok-4.6` | `non-interactive` | current | `0.2.117` | [grok-4.6.md](grok/prompts/grok-4.6.md) |
| `grok.prompt.agent.grok-4-6.interactive` | agent prompt | `grok-4.6` | `interactive` | current | `0.2.117` | [grok-4.6-interactive.md](grok/prompts/grok-4.6-interactive.md) |
| `grok.prompt.special.session-title` | session title prompt | `grok-4.5` | `session-title` | current | `0.2.117` | [grok-session-title.md](grok/prompts/grok-session-title.md) |
| `grok.steering.catalog` | steering messages | `grok-4.6` | `non-interactive`, `interactive` | current | `0.2.117` | [grok-4.6-steering.md](grok/misc/grok-4.6-steering.md), [grok-4.6-interactive-steering.md](grok/misc/grok-4.6-interactive-steering.md) |
| `grok.tool.catalog` | tool schemas | `grok-4.6` | `non-interactive`, `interactive`, `session-title` | current | `0.2.117` | 28 files ([manifest](grok/SURFACES.json)) |
